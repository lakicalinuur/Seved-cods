...
# Added handler for translation language selection
...
def callback_translate_to(call):
    ...
    lang_code = STT_LANGUAGES.get(lang_name, "en")
    ...
    instruction = f"Translate the following text to {lang_name}. Only provide the translation:"
    translated = ask_gemini(transcription, instruction)
...
# Added handler for summarization language selection
...
def callback_summarize_in(call):
    ...
    instruction = f"Summarize the following text in {lang_name}. Only provide the summary:"
    summary = ask_gemini(transcription, instruction)
